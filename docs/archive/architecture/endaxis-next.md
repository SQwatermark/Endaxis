...
> Endaxis Next 的长期架构文档已经整理到 [`docs/next`](../../README.md)。
> 新读者请从[为什么要建设 Next](../../README.md)开始；需要定位代码时阅读
> [分层架构](../../architecture/README.md)和[端到端数据流](../../architecture/data-and-state.md)。
>
