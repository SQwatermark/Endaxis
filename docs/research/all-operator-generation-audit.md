...
> 2026-08-30 补充：本文的 320/320 是旧全入口结构审计口径；统一 TS 正式主动技能迁移另有更严格的
> 产品生成门禁。该门禁当前为 274/310，Tangtang 为 9/10；其唯一阻塞是嵌套投射物在 3 秒
> `finishDuration` 到期后执行的战斗可见回调。两套数字不可互相替代。
