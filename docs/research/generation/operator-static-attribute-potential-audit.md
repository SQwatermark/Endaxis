...
- `docs/research/operators/arcane-next-evidence.md` 与现有装备生成映射：`attrType 87` 在用户面板中对应
...
`docs/research/generation/operator-progression-runtime-closure-gaps.md`。机器审计同步在
