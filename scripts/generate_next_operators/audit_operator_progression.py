...
TALENT_DEFINITION_COMPILERS = {"attachedBuff", "attachedPassive", "attachedPassiveWithConditionalCooldown", "skillBlackboardPatch", "targetStaggeredDamage", "consumedInflictionVulnerability", "consumedNoGuardPhysicalDamage", "akekuriComboImbue", "simulationNoEffectUniqueEnemy", "simulationNoEffectOnTakeDamage", "simulationNoEffectOnBeforeTakeSpellInfliction"}
TALENT_SIMULATION_COMPILERS = {"attachedBuff", "attachedPassive", "attachedPassiveWithConditionalCooldown", "skillBlackboardPatch", "targetStaggeredDamage", "consumedInflictionVulnerability", "consumedNoGuardPhysicalDamage", "akekuriComboImbue", "simulationNoEffectUniqueEnemy", "simulationNoEffectOnTakeDamage", "simulationNoEffectOnBeforeTakeSpellInfliction"}
