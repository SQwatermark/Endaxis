...
export const antalGeneratedOperator: OperatorDefinition = {
  ...
  comboSkillRegistrations: [{ skillKey: 'comboSkill', priority: 'default', invalidCastBlackboard: { EntityBB_combo_type: 2, EntityBB_combo_index: -1 }, rules: [{ trigger: { kind: 'elementalInflictionApplied', elements: 'heat', scope: 'team' }, condition: { kind: 'buffIdStackCompare', target: 'enemy', buffIds: ['buff_chr_0023_antal_tageffect'], operator: 'greater', value: 0 }, blackboard: { EntityBB_combo_type: 0, EntityBB_combo_index: 0 } }, { trigger: { kind: 'elementalInflictionApplied', elements: 'electric', scope: 'team' }, condition: { kind: 'buffIdStackCompare', target: 'enemy', buffIds: ['buff_chr_0023_antal_tageffect'], operator: 'greater', value: 0 }, blackboard: { EntityBB_combo_type: 0, EntityBB_combo_index: 1 } }, { trigger: { kind: 'elementalInflictionApplied', elements: 'cryo', scope: 'team' }, condition: { kind: 'buffIdStackCompare', target: 'enemy', buffIds: ['buff_chr_0023_antal_tageffect'], operator: 'greater', value: 0 }, blackboard: { EntityBB_combo_type: 0, EntityBB_combo_index: 2 } }, { trigger: { kind: 'elementalInflictionApplied', elements: 'nature', scope: 'team' }, condition: { kind: 'buffIdStackCompare', target: 'enemy', buffIds: ['buff_chr_0023_antal_tageffect'], operator: 'greater', value: 0 }, blackboard: { EntityBB_combo_type: 0, EntityBB_combo_index: 3 } }, { trigger: { kind: 'physicalInflictionApplied', types: 'airborne', scope: 'team' }, condition: { kind: 'buffIdStackCompare', target: 'enemy', buffIds: ['buff_chr_0023_antal_tageffect'], operator: 'greater', value: 0 }, blackboard: { EntityBB_combo_type: 1, EntityBB_combo_index: 0 } }, { trigger: { kind: 'physicalInflictionApplied', types: 'knockDown', scope: 'team' }, condition: { kind: 'buffIdStackCompare', target: 'enemy', buffIds: ['buff_chr_0023_antal_tageffect'], operator: 'greater', value: 0 }, blackboard: { EntityBB_combo_type: 1, EntityBB_combo_index: 1 } }, { trigger: { kind: 'physicalInflictionApplied', types: 'fracture', scope: 'team' }, condition: { kind: 'buffIdStackCompare', target: 'enemy', buffIds: ['buff_chr_0023_antal_tageffect'], operator: 'greater', value: 0 }, blackboard: { EntityBB_combo_type: 1, EntityBB_combo_index: 2 } }, { trigger: { kind: 'physicalInflictionApplied', types: 'crush', scope: 'team' }, condition: { kind: 'buffIdStackCompare', target: 'enemy', buffIds: ['buff_chr_0023_antal_tageffect'], operator: 'greater', value: 0 }, blackboard: { EntityBB_combo_type: 1, EntityBB_combo_index: 3 } }] }],
  talents: [
    {
      key: 'talent1',
      levels: 2,
