...
export const lifengUltimate: SkillDefinition = withSkillBlackboard(
  {
    ...
    scheduledSequences: [
      ...
      scheduled(
        58,
        sequence(
          step('spawnAbilityEntity', { templateId: 'abilityentity_chr_0015_lifeng_ultimate_skill', dieWhenSourceDies: false, childSkillId: 'chr_0015_lifeng_ultimate_skill_abentity', inheritActionBlackboard: true }),
        ),
      ),
      scheduled(
        64,
