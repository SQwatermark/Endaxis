  ...
  buffDefinitions: {
    ...
    'buff_chr_0032_lizhiyan_combo_skill_spell_vulnerable_pre': {
      ...
      presentation: {
        ...
        iconPath: '/operators/arcane/icon_battle_buff_lizhiyan_combo_vulnerable.webp',
    ...
    'buff_chr_0032_lizhiyan_combo_skill_seal2': {
      ...
      presentation: {
        ...
        iconPath: '/operators/arcane/icon_battle_buff_lizhiyan_combo_seal.webp',
        showInHeadBarCommon: true,
        showInHeadBarAttached: false,
        showInSquadIcon: false,
        onlyShowForMainCharacter: false,
    ...
    'buff_chr_0032_lizhiyan_ultimate_skill_listener': {
      ...
      lifecycleSequences: {
        start: sequence(
          ...
          step('changeResource', { resource: 'ultimateEnergy', amount: 1, recipient: 'caster', isPercentValue: true, ultimateRecoveryTag: "Skill/Character/chr_0032_lizhiyan/special_usp" }),
          branch(
            {
              kind: 'actionValueCompare',
              left: { kind: 'blackboard', key: 'EntityBB_wisd_greater_will' },
