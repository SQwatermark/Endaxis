...
export const commonBuffDefinitions = {
  ...
  buff_common_affixes_enhance_spell: {
    ...
    maxStackCount: 0,
    durationSeconds: { blackboardKey: 'duration' },
    applyTagIds: [-1748167886, 486772476, -1920931676, 191477865, -1046270741, 895316857],
    extendTagIds: [],
    blackboard: {
  ...
  buff_common_full_immune: {
    ...
    durationSeconds: { blackboardKey: 'duration' },
    applyTagIds: [
      -1706530655, -808036568, -279045144, 1643653132, 2056757668, 195489960, 2136825092, 486381712,
      782082172, -104052028, -886962248,
    ],
    extendTagIds: [],
    blackboard: { duration: 9999 },
    attributeModifiers: [],
  ...
  buff_common_full_immune_medium: {
    ...
    durationSeconds: { blackboardKey: 'duration' },
    applyTagIds: [
      -808036568, -279045144, 1643653132, 2056757668, 195489960, 2136825092, 486381712, 782082172,
      -104052028, -886962248,
    ],
    extendTagIds: [],
    blackboard: { duration: 9999 },
