...
const sharedActionSequence22: ActionSequenceDefinition = sequence(
  branch({ kind: 'casterControlled' }, sharedActionSequence23, undefined, { alwaysNext: true }),
);
...
export const typhoeusFloatingAttack2: SkillDefinition = withSkillBlackboard(
  {
    ...
    scheduledSequences: [
      ...
      scheduled(22, sharedActionSequence21, 25),
      scheduled(25, sequence(step('finishTimeline', {})), 28),
      scheduled(67, sharedActionSequence21, 70),
      scheduled(70, sequence(step('finishTimeline', {})), 73),
      scheduled(97, sharedActionSequence21, 100),
      scheduled(100, sequence(step('finishTimeline', {})), 103),
      scheduled(127, sharedActionSequence21, 130),
      scheduled(130, sequence(step('finishTimeline', {})), 133),
      scheduled(157, sharedActionSequence21, 160),
      scheduled(0, sharedActionSequence22, 1),
      scheduled(
        1,
        instantiateActionSequence(sharedActionSequence4, [
      ...
      scheduled(45, sharedActionSequence22, 46),
      scheduled(
        46,
        instantiateActionSequence(sharedActionSequence4, [
      ...
      scheduled(75, sharedActionSequence22, 76),
      scheduled(
        76,
        instantiateActionSequence(sharedActionSequence4, [
      ...
      scheduled(105, sharedActionSequence22, 106),
      scheduled(
        106,
        instantiateActionSequence(sharedActionSequence4, [
      ...
      scheduled(135, sharedActionSequence22, 136),
      scheduled(
        136,
        instantiateActionSequence(sharedActionSequence4, [
...
export const typhoeusFloatingAttack3: SkillDefinition = withSkillBlackboard(
  {
    ...
    scheduledSequences: [
      ...
      scheduled(23, sharedActionSequence24, 26),
...
export const typhoeusFloatingAttack4: SkillDefinition = withSkillBlackboard(
  {
    ...
    scheduledSequences: [
      ...
      scheduled(150, sharedActionSequence22, 151),
      scheduled(
        151,
        instantiateActionSequence(sharedActionSequence4, [
      ...
      scheduled(300, sharedActionSequence22, 301),
      scheduled(
        301,
        instantiateActionSequence(sharedActionSequence4, [
      ...
      scheduled(450, sharedActionSequence22, 451),
      scheduled(
        451,
        instantiateActionSequence(sharedActionSequence4, [
      ...
      scheduled(600, sharedActionSequence22, 601),
      scheduled(
        601,
        instantiateActionSequence(sharedActionSequence4, [
