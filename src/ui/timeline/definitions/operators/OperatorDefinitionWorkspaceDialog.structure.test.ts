...
import sequenceWorkspaceSource from '../actions/ActionSequenceWorkspace.vue?raw';
import comboDefinitionsSource from './OperatorComboDefinitionsDialog.vue?raw';
import skillEditorDialogSource from '../skills/SkillDefinitionEditorDialog.vue?raw';
