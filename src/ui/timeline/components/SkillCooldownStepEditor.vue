...
<template>
  <div class="step-editor__grid">
    <label>
      <EditorFieldLabel
        :label="t('timeline.skillEditing.cooldownSkillSelector')"
        :help="t('timeline.skillEditing.fieldHelp.cooldownSkillSelector')"
      />
      <select :value="step.parameters.skill.kind" @change="setSelectorKind">
        <option value="type">
          {{ t('timeline.skillEditing.cooldownSkillSelectorKinds.type') }}
        </option>
        <option value="id">
          {{ t('timeline.skillEditing.cooldownSkillSelectorKinds.id') }}
        </option>
      </select>
    </label>
    <label v-if="step.parameters.skill.kind === 'type'">
      <EditorFieldLabel
        :label="t('timeline.skillEditing.cooldownSkillType')"
        :help="t('timeline.skillEditing.fieldHelp.cooldownSkillType')"
      />
    ...
    <label v-else>
      <EditorFieldLabel
        :label="t('timeline.skillEditing.cooldownSkillId')"
        :help="t('timeline.skillEditing.fieldHelp.cooldownSkillId')"
      />
    ...
    <label>
      <EditorFieldLabel
        ...
        :help="t('timeline.skillEditing.fieldHelp.cooldownOperation')"
      />
      <select :value="step.parameters.operation" @change="setOperation">
        <option value="reduce">
          {{ t('timeline.skillEditing.cooldownOperations.reduce') }}
        </option>
        <option value="set">{{ t('timeline.skillEditing.cooldownOperations.set') }}</option>
      </select>
    </label>
    <label>
      <EditorFieldLabel
        :label="t('timeline.skillEditing.cooldownBasis')"
        :help="t('timeline.skillEditing.fieldHelp.cooldownBasis')"
      />
      <select
      ...
      >
        <option value="baseDurationRatio">
          {{ t('timeline.skillEditing.cooldownBases.baseDurationRatio') }}
        </option>
        <option value="absoluteSeconds">
          {{ t('timeline.skillEditing.cooldownBases.absoluteSeconds') }}
        </option>
      </select>
    </label>
    <label class="step-editor__operand">
      <EditorFieldLabel
        ...
        :help="t('timeline.skillEditing.fieldHelp.cooldownValue')"
      />
