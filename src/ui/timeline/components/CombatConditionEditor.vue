...
const conditionKindLabel = (kind: CombatConditionKind): string =>
  kind === 'enemyRankIn' ? 'Enemy rank' : t(`timeline.skillEditing.conditionKinds.${kind}`);
...
<template>
  <section class="condition-editor">
    <label class="condition-editor__field">
      <EditorFieldLabel
        :label="t('timeline.skillEditing.conditionKind')"
        :help="t('timeline.skillEditing.fieldHelp.conditionKind')"
      />
    ...
    <template v-if="condition.kind === 'currentSkillTypeIn'">
      <label class="condition-editor__field">
        <EditorFieldLabel :label="t('timeline.skillEditing.target')" />
        <select :value="condition.target" @change="setCurrentSkillTarget">
          <option value="caster">
            {{ t('timeline.skillEditing.currentSkillTargets.caster') }}
          </option>
          <option value="buffOwner">
            {{ t('timeline.skillEditing.currentSkillTargets.buffOwner') }}
          </option>
        </select>
      </label>
      <fieldset class="condition-editor__checks">
        <legend>{{ t('timeline.skillEditing.cooldownSkillType') }}</legend>
    ...
    >
      <EditorFieldLabel :label="t('timeline.skillEditing.conditionContextKey')" />
    ...
    >
      <label class="condition-editor__field">
        <EditorFieldLabel :label="t('timeline.skillEditing.actionContextIdentityOther')" />
        <select :value="condition.other" @change="setActionContextIdentityOther">
          <option value="controlledOperator">
            {{ t('timeline.skillEditing.actionContextIdentities.controlledOperator') }}
          </option>
          <option value="actionSource">
            {{ t('timeline.skillEditing.actionContextIdentities.actionSource') }}
          </option>
          <option value="actionOwner">
            {{ t('timeline.skillEditing.actionContextIdentities.actionOwner') }}
          </option>
        </select>
      </label>
      <label class="condition-editor__field">
        <EditorFieldLabel :label="t('timeline.skillEditing.comparisonOperator')" />
        <select :value="condition.operator" @change="setIdentityComparison">
          <option value="equal">
            {{ t('timeline.skillEditing.comparisonOperators.equal') }}
          </option>
          <option value="notEqual">
            {{ t('timeline.skillEditing.comparisonOperators.notEqual') }}
          </option>
        </select>
      </label>
    </template>
    <label
      ...
      class="condition-editor__field"
    >
      <EditorFieldLabel :label="t('timeline.skillEditing.conditionObjectTypeMask')" />
      <input
        type="number"
        step="1"
        min="-2147483648"
    ...
    <label v-if="condition.kind === 'skillBranchEnabled'" class="condition-editor__field"
      ><EditorFieldLabel
        :label="t('timeline.skillEditing.branchKey')"
        :help="t('timeline.skillEditing.fieldHelp.branchKey')" /><input
        type="text"
    ...
    <label
      ...
      ><EditorFieldLabel
        ...
        :help="t('timeline.skillEditing.fieldHelp.conditionTarget')"
    ...
    <template v-if="condition.kind === 'healthCompare'">
      <label class="condition-editor__field"
        ><EditorFieldLabel
          :label="t('timeline.skillEditing.healthValueType')"
          :help="t('timeline.skillEditing.fieldHelp.healthValueType')"
        /><select
        ...
        >
          <option value="current">
            {{ t('timeline.skillEditing.healthValueTypes.current') }}
          </option>
          <option value="ratio">{{ t('timeline.skillEditing.healthValueTypes.ratio') }}</option>
        </select></label
      >
      <label class="condition-editor__field"
        ><EditorFieldLabel
          :label="t('timeline.skillEditing.comparisonOperator')"
          :help="t('timeline.skillEditing.fieldHelp.comparisonOperator')"
        /><select :value="condition.operator" @change="setComparison">
          <option v-for="operator in COMPARISON_OPERATORS" :key="operator" :value="operator">
            {{ t(`timeline.skillEditing.comparisonOperators.${operator}`) }}
          </option>
        </select></label
      >
      <label class="condition-editor__operand"
        ><EditorFieldLabel
          :label="t('timeline.skillEditing.compareValue')"
          :help="t('timeline.skillEditing.fieldHelp.conditionOperand')" /><ActionValueOperandEditor
    ...
    <template v-if="condition.kind === 'poiseCompare'">
      ...
      <label class="condition-editor__check">
        ...
        />
        <EditorFieldLabel
          :label="t('timeline.skillEditing.returnValueIfPoiseMissing')"
          :help="t('timeline.skillEditing.fieldHelp.returnValueIfPoiseMissing')"
        />
      </label>
    </template>
    ...
    >
      ...
      <label class="condition-editor__operand"
        ><EditorFieldLabel
          :label="
            t(
              `timeline.skillEditing.${condition.kind === 'currentBuffStackCompare' ? 'compareValue' : 'superArmor'}`,
            )
          "
          :help="t('timeline.skillEditing.fieldHelp.conditionOperand')" /><ActionValueOperandEditor
          :value="condition.value"
    ...
    <template v-if="condition.kind === 'cameraToTargetAngleCompare'">
      ...
      <label class="condition-editor__operand"
        ><EditorFieldLabel
          :label="t('timeline.skillEditing.cameraTargetAngle')"
          :help="t('timeline.skillEditing.fieldHelp.conditionOperand')" /><ActionValueOperandEditor
          :value="condition.value"
          :labels="operandLabels()"
          @update="setOperand('value', $event)"
    ...
    <template v-if="condition.kind === 'contextFlagEquals'">
      <label class="condition-editor__field"
        ><EditorFieldLabel
          ...
          :help="t('timeline.skillEditing.fieldHelp.contextFlag')" /><input
          type="text"
      ...
      <label class="condition-editor__field"
        ><EditorFieldLabel
          ...
          :help="t('timeline.skillEditing.fieldHelp.contextValue')" /><select
        ...
        >
          ...
          <option value="false">
            {{ t('timeline.skillEditing.booleanValues.false') }}
          </option></select
        ><input
          v-else
    ...
    <label v-if="condition.kind === 'probability'" class="condition-editor__operand"
      ><EditorFieldLabel
        :label="t('timeline.skillEditing.probability')"
        :help="t('timeline.skillEditing.fieldHelp.conditionOperand')" /><ActionValueOperandEditor
    ...
    <template v-if="condition.kind === 'statusActive'">
      <label class="condition-editor__field"
        ><EditorFieldLabel
          ...
          :help="t('timeline.skillEditing.fieldHelp.statusKey')" /><input
          type="text"
      ...
      <label class="condition-editor__optional"
        ><input
          ...
          :label="t('timeline.skillEditing.minimumStacks')"
          :help="t('timeline.skillEditing.fieldHelp.minimumStacks')" /><input
    ...
    >
      <label class="condition-editor__field"
        ><EditorFieldLabel
          :label="t('timeline.skillEditing.tagQueryType')"
          :help="t('timeline.skillEditing.fieldHelp.tagQueryType')"
        /><select :value="condition.tagQueryType" @change="setTagQueryType">
          <option v-for="type in TAG_QUERY_TYPES" :key="type" :value="type">
            {{ t(`timeline.skillEditing.tagQueryTypes.${type}`) }}
          </option>
        </select></label
      >
      <label class="condition-editor__field"
        ><EditorFieldLabel
          :label="t('timeline.skillEditing.buffTags')"
          :help="t('timeline.skillEditing.fieldHelp.buffTags')"
        /><GameplayTagsEditor
          :tags="
      ...
      <template
        ...
        ><label class="condition-editor__operand"
          ><EditorFieldLabel
            :label="t('timeline.skillEditing.compareValue')"
            :help="
              t('timeline.skillEditing.fieldHelp.conditionOperand')
    ...
    <template v-if="condition.kind === 'buffIdStackCompare'">
      <label class="condition-editor__field"
        ><EditorFieldLabel
          :label="t('timeline.skillEditing.buffIds')"
          :help="t('timeline.skillEditing.fieldHelp.buffIds')"
      ...
      <label class="condition-editor__field"
        ><EditorFieldLabel
          :label="t('timeline.skillEditing.valueTypes.number')"
          :help="t('timeline.skillEditing.fieldHelp.buffStackValueKind')"
        /><select
          :value="typeof condition.value === 'number' ? 'scalar' : 'operand'"
          @change="setBuffStackValueKind"
        >
          <option value="scalar">{{ t('timeline.skillEditing.scalarValue') }}</option>
          <option value="operand">{{ t('timeline.skillEditing.actionOperandValue') }}</option>
        </select></label
      >
      <label v-if="typeof condition.value === 'number'" class="condition-editor__field"
        ><EditorFieldLabel
          :label="t('timeline.skillEditing.compareValue')"
          :help="t('timeline.skillEditing.fieldHelp.buffStackValue')" /><input
          type="number"
          :value="condition.value"
    ...
    <label
      ...
      ><EditorFieldLabel
        ...
        :help="t('timeline.skillEditing.fieldHelp.markerId')" /><input
        type="text"
    ...
    <template v-if="condition.kind === 'eventDamageTagsMatch'">
      <label class="condition-editor__field"
        ><EditorFieldLabel
          :label="t('timeline.skillEditing.tagQueryType')"
          :help="t('timeline.skillEditing.fieldHelp.eventDamageTags')"
    ...
    <template v-if="condition.kind === 'eventDamageFeaturesMatch'">
      <label class="condition-editor__field"
        ><EditorFieldLabel
          :label="t('timeline.skillEditing.tagQueryType')"
          :help="t('timeline.skillEditing.fieldHelp.eventDamageFeatures')"
        /><select :value="condition.match" @change="setEventTagMatch">
          <option v-for="type in EVENT_TAG_MATCH_TYPES" :key="type" :value="type">
            {{ t(`timeline.skillEditing.tagQueryTypes.${type}`) }}
          </option>
      ...
      >
      <fieldset class="condition-editor__elements">
        <legend>{{ t('timeline.skillEditing.damageFeatures') }}</legend>
        <label v-for="feature in DAMAGE_FEATURES" :key="feature"
          ...
          />{{ t(`timeline.skillEditing.damageFeatureNames.${feature}`) }}</label
        >
      </fieldset>
    </template>
    ...
    <template v-if="condition.kind === 'eventDamageTypeIn'">
      <fieldset class="condition-editor__elements">
        <legend>{{ t('timeline.skillEditing.damageType') }}</legend>
        <label v-for="damageType in DAMAGE_TYPES" :key="damageType"
          ...
          />{{ t(`timeline.skillEditing.damageTypes.${damageType}`) }}</label
        >
      </fieldset>
    </template>
    ...
    <template v-if="condition.kind === 'eventInflictionElementIn'">
      <fieldset class="condition-editor__elements">
        <legend>{{ t('timeline.skillEditing.element') }}</legend>
        <label v-for="element in INFLICTION_ELEMENTS" :key="element"
          ...
          />{{ t(`timeline.skillEditing.damageTypes.${element}`) }}</label
        >
      </fieldset>
    </template>
    ...
    <template v-if="condition.kind === 'elementalInflictionPresent'">
      <fieldset class="condition-editor__elements">
        <legend>
          <EditorFieldLabel
            :label="t('timeline.skillEditing.element')"
            :help="t('timeline.skillEditing.fieldHelp.conditionElement')"
          />
        </legend>
    ...
    <template v-if="condition.kind === 'elementalReactionActive'">
      <label class="condition-editor__field"
        ><EditorFieldLabel
          :label="t('timeline.skillEditing.reaction')"
          :help="t('timeline.skillEditing.fieldHelp.reaction')"
        /><select :value="condition.reaction" @change="setReaction">
          <option v-for="reaction in ELEMENTAL_REACTIONS" :key="reaction" :value="reaction">
            {{ t(`timeline.skillEditing.reactions.${reaction}`) }}
          </option>
        </select></label
      >
      <label class="condition-editor__optional"
        ><input
          ...
          :label="t('timeline.skillEditing.minimumLevel')"
          :help="t('timeline.skillEditing.fieldHelp.minimumLevel')" /><input
    ...
    <template v-if="condition.kind === 'deckAttributeCompare'">
      <label class="condition-editor__field"
        ><EditorFieldLabel
          :label="t('timeline.skillEditing.operandLeft')"
          :help="t('timeline.skillEditing.fieldHelp.operatorAttribute')"
