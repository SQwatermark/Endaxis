...
未修改输入的当前版本配置截止帧是 2139：504 条伤害，期望伤害
`3234025.679136203`，最后伤害在 2131 帧。跑满 3600 帧则为 609 条、
`3397425.1423854693`，额外 105 条都来自洛茜，最后一条在 2761 帧。这里分别保留
“配置截止”和“完整战斗”两个口径，不用完整战斗结果覆盖用户保存的截止线。

配置截止内的来源为：弭弗 70 条、`1585422.9758164021`；洛茜 387 条、
`1413335.3354000663`；卡蜜拉 34 条、`148335.83549247176`；骏卫 13 条、
...
| 卡蜜拉 |       32 |       34 |       320803 | `148335.83549247176` |
