...
```powershell
python tools/game-data-compiler/legacy/enemy-ranks/extract_enemy_ranks.py
python -m unittest discover tools/game-data-compiler/legacy/enemy-ranks -p "test_*.py"
```
